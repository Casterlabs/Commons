...
public class Vector4l {
	 ...
	 */
    public Vector4l(@NonNull long[] arr) {
	 ...
	 */
    public Vector4l add(@NonNull Vector4l other) {
	 ...
	 */
    public Vector4l sub(@NonNull Vector4l other) {
		long[] arr = this.toArray();
		long[] otherArr = other.toArray();
