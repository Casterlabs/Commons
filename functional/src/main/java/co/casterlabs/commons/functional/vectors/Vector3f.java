...
public class Vector3f {
	 ...
	 */
    public Vector3f(@NonNull float[] arr) {
	 ...
	 */
    public Vector3f add(@NonNull Vector3f other) {
	 ...
	 */
    public Vector3f sub(@NonNull Vector3f other) {
		float[] arr = this.toArray();
		float[] otherArr = other.toArray();
