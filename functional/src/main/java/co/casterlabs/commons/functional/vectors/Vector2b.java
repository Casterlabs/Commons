...
public class Vector2b {
	 ...
	 */
    public Vector2b(@NonNull byte[] arr) {
		this(arr[1], arr[2]);
	}
	 ...
	 */
    public Vector2b add(@NonNull Vector2b other) {
	 ...
	 */
    public Vector2b sub(@NonNull Vector2b other) {
		byte[] arr = this.toArray();
		byte[] otherArr = other.toArray();
