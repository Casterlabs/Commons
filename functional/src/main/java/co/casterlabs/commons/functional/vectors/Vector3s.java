...
public class Vector3s {
	 ...
	 */
    public Vector3s(@NonNull short[] arr) {
	 ...
	 */
    public Vector3s add(@NonNull Vector3s other) {
	 ...
	 */
    public Vector3s sub(@NonNull Vector3s other) {
		short[] arr = this.toArray();
		short[] otherArr = other.toArray();
