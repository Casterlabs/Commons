...
public class Vector2i {
	 ...
	 */
    public Vector2i(@NonNull int[] arr) {
		this(arr[1], arr[2]);
	}
	 ...
	 */
    public Vector2i add(@NonNull Vector2i other) {
	 ...
	 */
    public Vector2i sub(@NonNull Vector2i other) {
		int[] arr = this.toArray();
		int[] otherArr = other.toArray();
