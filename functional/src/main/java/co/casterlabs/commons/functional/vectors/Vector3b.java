...
public class Vector3b {
	 ...
	 */
    public Vector3b(@NonNull byte[] arr) {
	 ...
	 */
    public Vector3b add(@NonNull Vector3b other) {
	 ...
	 */
    public Vector3b sub(@NonNull Vector3b other) {
		byte[] arr = this.toArray();
		byte[] otherArr = other.toArray();
